...
if (env === 'development') {
  ...
  // Paso 4 .Agregando el Middleware a la cadena de midlewares de nuestra aplicacion
  app.use(
  ...
  console.log('> Executing in Production Mode : Webpack Hot Reloading');
}
...
// Instalando el enrutador pincipal a
...
app.use((req, res, next) => {
  // Log
  winston.error(
    `Code: 404, Message: Page Not Found, URL: ${req.originalUrl}, Method: ${
      req.method
    }`,
  );
